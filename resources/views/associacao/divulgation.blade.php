...
<script type="text/javascript" src="/assets/js/carrossel.js"></script>
    ...
    {{-- Carrosel com imagens de entrega de bíblias pelo pastor--}}
    <div class="container">
...
{{-- Carrosel com imagens de entrega de bíblias--}}
    <div class="container">
        ...
        <div class="gallery-wrapper">
            <div class="gallery">
                <img class="item" src="/assets/img/entrega-biblias/entrega-biblias.jpeg"
                alt="Pastor Volni entregando Bíblias a pessoas">
                <img class="item current-item" src="/assets/img/entrega-biblias/entrega-biblias-2.jpeg"
                 alt="Pastor Volni entregando Bíblias a pessoas">
                <img class="item" src="/assets/img/entrega-biblias/entrega-biblias-3.jpeg"
                alt="Pastor Volni entregando Bíblias a pessoas">
                <img class="item" src="/assets/img/entrega-biblias/entrega-biblias-4.jpeg"
                alt="Pastor Volni entregando Bíblias a pessoas">
                <img class="item" src="/assets/img/entrega-biblias/entrega-biblias-5.jpeg"
            alt="Pastor Volni entregando Bíblias a pessoas">
                <img class="item" src="/assets/img/entrega-biblias/entrega-biblias-6.jpeg" alt="Pastor Volni entregando Bíblias a pessoas">
                <img class="item" src="/assets/img/entrega-biblias/entrega-biblias-7.jpeg"
               alt="Pastor Volni entregando Bíblias a pessoas">
            </div>
        </div>
    </div>
