...
<p class="text_center" id="text_page_sobre">
    ...
    Nossa história inicia no <strong>ano de 2023</strong>, quando o <strong>Pastor Volni</strong>, juntamente com <strong>Ev. Jacy Faust</strong>, atual presidente da associação, decidem criar uma associação para distribuições de literaturas, a exemplo da Bíblia Sagrada. <br>

    Porém o <strong>Pastor Volni</strong>, atual tesoureiro da Associação Palavra de Vida, realiza distribuição de Bíblias há mais de duas décadas por onde quer que esteve pastorando, seja em cidades como Lages, Blumenau como também em Capão Alto, Campo Belo do Sul e Ponte Alta do Norte.<br>
...
<video controls class="video_page_sobre">
...
<p class="text_center" id="text_page_sobre">Vídeo institucional por tesoureiro, Pastor Volni</p>
